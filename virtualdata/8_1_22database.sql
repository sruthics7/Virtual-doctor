...
(1,20,'torchuring','0000-00-00','hnjubi'),
(2,32,'easzrftgsfg','2022-01-07','pending'),
(3,32,'gbgbgnhgjjngfb','2022-01-07','pending'),
(4,33,'lkmjuyuyti787i','2022-03-14','pending'),
(5,33,'fdjhuy','2022-03-14','pending'),
(6,52,'SEND','2022-03-16','pending'),
(7,52,'SEND','2022-03-16','pending'),
(8,52,'SEND','2022-03-17','pending'),
(9,52,'SEND','2022-03-17','pending'),
(10,52,'SEND','2022-03-17','pending'),
(11,33,'rtfedtg','2022-03-17','pending');
...
(15,51,'gfc','bgv','6/06/2001','female','bxgth','nh',' bgjnjm','456789',0,'9344343951',9344343951,22);
...
(3,'50','tg','2022-01-08'),
(4,'50','bcbc','2022-01-08'),
(5,'50','','2022-01-08'),
(6,'33','thugghk','2022-03-14'),
(7,'33','bjnhgj','2022-03-14'),
(8,'52','good','2022-03-16'),
(9,'52','hgdd','2022-03-16'),
(10,'52','bgcv','2022-03-16'),
(11,'52','hah','2022-03-17'),
(12,'33','dgdrtj','2022-03-17');
...
(2,'nlol','hyujgu',78,'2019-12-01','122',50),
(3,'dggggjh','gft',34,'2018-07-12','200',50);
...
insert  into `orders`(`Order_id`,`User_id`,`Med_id`,`Date`,`Quantity`,`Status`) values 
(1,20,1,'2022-01-08',5,'pending');
...
(1,18,'thavala','oolampara','kuthiravattam',320721,'thavala12@gamil.com',8848387238,'11.2576908','75.7843774'),
(2,19,'nenju','anappara','kuthiravattm',673642,'nenju34@gmail.com',9876543210,'11.2576908','75.7843774'),
(3,44,'','','',0,'',0,'',''),
...
(9,50,'riaaa','kalpetta','kalpetta',673642,'ria@gmail.com',6238554079,'3','4');
...
(2,52,'anu','renj','MALE',3,'vazhavatta','vazhavatta',673122,9061660339);
