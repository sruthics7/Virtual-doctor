...
public class chat extends AppCompatActivity implements AdapterView.OnItemClickListener,AdapterView.OnItemSelectedListener {
    ListView lv1;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url1,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> ad=new ArrayAdapter<String>(chat.this,android.R.layout.simple_list_item_1,hosp);
                    s.setAdapter(ad);
                    s.setOnItemSelectedListener(chat.this);


                } catch (Exception e) {
                    Toast.makeText(chat.this, "exp"+e, Toast.LENGTH_SHORT).show();
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            lv1.setAdapter(new custom3(chat.this,name,department,phone));
                            lv1.setOnItemClickListener(chat.this);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent im=new Intent(getApplicationContext(),chat1.class);
        im.putExtra("fid",did.get(i));
        im.putExtra("name",name.get(i));
        startActivity(im);
